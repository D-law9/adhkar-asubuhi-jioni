...
// Adhkār za Asubuhi. Order per spec section 5: Āyat al-Kursī, then the three
// Quls, open the session; the 20 hadith-based duas follow in their original
// order (Sayyid al-Istighfār → Ṣalāh na Salām kwa Mtume ﷺ).

const duas: DhikrItem[] = [
  {
    id: 'asubuhi-05-sayyid-al-istighfar',
    arabic:
    ...
    sw: {
      ...
      benefit:
        'Atakayeisema wakati wa mchana akiwa na yakini nayo, kisha akafa siku hiyo kabla ya jioni, atakuwa miongoni mwa watu wa Peponi. — Ṣaḥīḥ al-Bukhārī (6306).',
    },
  },
  {
    id: 'asubuhi-06-kuanza-asubuhi',
    arabic: 'اللَّهُمَّ بِكَ أَصْبَحْنَا، وَبِكَ أَمْسَيْنَا، وَبِكَ نَحْيَا، وَبِكَ نَمُوتُ، وَإِلَيْكَ النُّشُورُ',
    translit: 'Allāhumma bika aṣbaḥnā, wa bika amsaynā, wa bika naḥyā, wa bika namūtu, wa ilaykan-nushūr.',
    count: 1,
    sourceCitation: 'At-Tirmidhī 3391; graded ṣaḥīḥ by Al-Albani.',
    sw: {
      title: 'Dua ya Kuanza Asubuhi',
      meaning:
        'Ewe Allah, kwa uwezo Wako tumeifikia asubuhi, kwa uwezo Wako tunaifikia jioni, kwa uwezo Wako tunaishi na tunakufa, na Kwako ndiko kufufuliwa.',
      benefit: 'Mtume ﷺ alikuwa akiisema kila asubuhi. — At-Tirmidhī (3391).',
    },
  },
  {
    id: 'asubuhi-07-ufalme-ni-wa-allah',
    arabic:
    ...
    count: 1,
    sourceCitation: 'Ṣaḥīḥ Muslim 2723.',
    sw: {
      title: 'Asubuhi Imefika, Ufalme ni wa Allah',
      meaning:
        'Tumeifikia asubuhi, na ufalme ni wa Allah, sifa njema zote ni za Allah. Hakuna mola apasaye kuabudiwa kwa haki ila Allah, Peke Yake, hana mshirika. Ufalme ni wake na sifa njema ni zake, na Yeye ni Muweza wa kila kitu. Mola wangu, nakuomba kheri ya siku hii na kheri ya baada yake, na najikinga kwako na shari ya siku hii na shari ya baada yake. Mola wangu, najikinga kwako na uvivu na uzee mbaya. Mola wangu, najikinga kwako na adhabu ya Motoni na adhabu ya kaburini.',
      benefit:
        'Mtume ﷺ alifundisha dua hii kwa masahaba wake ili waiseme kila asubuhi. — Ṣaḥīḥ Muslim (2723).',
    },
  },
  {
    id: 'asubuhi-08-kumshuhudisha-allah',
    arabic:
    ...
    translit:
      "Allāhumma innī aṣbaḥtu ush-hiduk, wa ush-hidu ḥamalata 'arshik, wa malā'ikatak, wa jamī'a khalqik, annaka antallāhu lā ilāha illā anta waḥdaka lā sharīka lak, wa anna Muḥammadan 'abduka wa rasūluk.",
    count: 4,
    sourceCitation: 'Abū Dāwūd 5069; graded ṣaḥīḥ by Al-Albani.',
    sw: {
      title: 'Kumshuhudisha Allah na Viumbe Vyake',
      meaning:
        'Ewe Allah, hakika mimi nimeifikia asubuhi nikikushuhudisha Wewe, na nawashuhudisha wabeba Kiti chako cha Enzi, na Malaika Wako, na viumbe Vyako vyote, kwamba Wewe ndiwe Allah, hakuna mola apasaye kuabudiwa kwa haki ila Wewe Peke Yako, hauna mshirika, na kwamba Muhammad ni mja Wako na Mtume Wako.',
      benefit:
        'Yeyote atakayesema hivyo mara nne asubuhi, Allah atamwokoa robo yake na Motoni. Na atakayesema mara nane, Allah atamwokoa yote na Motoni. — Abū Dāwūd (5069).',
    },
  },
  {
    id: 'asubuhi-09-kumshukuru-kwa-neema',
    arabic: 'اللَّهُمَّ مَا أَصْبَحَ بِي مِنْ نِعْمَةٍ أَوْ بِأَحَدٍ مِنْ خَلْقِكَ، فَمِنْكَ وَحْدَكَ لَا شَرِيكَ لَكَ، فَلَكَ الْحَمْدُ وَلَكَ الشُّكْرُ',
    translit:
      "Allāhumma mā aṣbaḥa bī min ni'matin aw bi'aḥadin min khalqik, faminka waḥdaka lā sharīka lak, falakal-ḥamdu wa lakash-shukr.",
    count: 1,
    sourceCitation: 'Abū Dāwūd 5073; graded ṣaḥīḥ by Al-Albani.',
    sw: {
      title: 'Kumshukuru Allah kwa Neema',
      meaning:
        'Ewe Allah, kila neema niliyoifikia nayo asubuhi hii, au mtu yeyote katika viumbe Vyako, basi imetoka Kwako Peke Yako, hauna mshirika. Basi sifa njema ni Zako na shukrani ni Zako.',
      benefit:
        'Atakayeisema asubuhi, atakuwa amemtekelezea Allah shukrani ya siku hiyo. — Abū Dāwūd (5073).',
    },
  },
  {
    id: 'asubuhi-10-afya-mwili-kusikia-kuona',
  ...
  {
    id: 'asubuhi-13-ubaya-nafsi-shaytani',
    arabic:
  ...
  {
    id: 'asubuhi-14-bismillah-ulinzi',
  ...
  {
    id: 'asubuhi-16-ya-hayyu-ya-qayyum',
  ...
  },
  {
    ...
    translit:
      "Aṣbaḥnā wa aṣbaḥal-mulku lillāhi Rabbil-'ālamīn, Allāhumma innī as'aluka khayra hādhal-yawm: fatḥahū wa naṣrahū wa nūrahū wa barakatahū wa hudāh, wa a'ūdhu bika min sharri mā fīhi wa sharri mā ba'dah.",
    count: 1,
    sourceCitation: 'Abū Dāwūd 5084; graded ḥasan by Al-Albani.',
    sw: {
      title: 'Kuomba Kheri ya Siku',
      meaning:
        'Tumeifikia asubuhi, na ufalme ni wa Allah, Mola wa walimwengu wote. Ewe Allah, nakuomba kheri ya siku hii: ufunguzi wake, msaada wake, nuru yake, baraka zake na uongofu wake, na najikinga kwako na shari iliyomo humo na shari ya baada yake.',
      benefit:
        "Sehemu ya dua ndefu iliyopokewa kutoka kwa Abdullāh bin Mas'ūd (Allah amuwiye radhi). — Abū Dāwūd (5084).",
    },
  },
  {
    id: 'asubuhi-18-fitrah-ya-uislamu',
    arabic:
    ...
    translit:
      "Aṣbaḥnā 'alā fiṭratil-Islām, wa 'alā kalimatil-ikhlāṣ, wa 'alā dīni Nabiyyinā Muḥammadin ṣallallāhu 'alayhi wa sallam, wa 'alā millati abīnā Ibrāhīma ḥanīfan musliman wa mā kāna minal-mushrikīn.",
    count: 1,
    sourceCitation: 'Aḥmad 15367; graded ḥasan by Al-Albani.',
    sw: {
      title: 'Kuianza Siku Juu ya Uislamu',
      meaning:
        'Tumeifikia asubuhi tukiwa juu ya maumbile ya Uislamu, na juu ya neno la ikhlasi, na juu ya dini ya Nabii wetu Muhammad ﷺ, na juu ya mila ya baba yetu Ibrahim, mnyoofu, Muislamu, wala hakuwa miongoni mwa washirikina.',
      benefit: 'Imepokewa kutoka kwa hadithi ya Abū Hurayrah. — Aḥmad (15367).',
    },
  },
  {
    id: 'asubuhi-19-subhanallahi-wa-bihamdih',
  ...
  {
    id: 'asubuhi-20-la-ilaha-illallah',
  ...
  {
    id: 'asubuhi-21-tasbihi-ya-juwayriyah',
    arabic: 'سُبْحَانَ اللَّهِ وَبِحَمْدِهِ عَدَدَ خَلْقِهِ، وَرِضَا نَفْسِهِ، وَزِنَةَ عَرْشِهِ، وَمِدَادَ كَلِمَاتِهِ',
    translit: "Subḥānallāhi wa biḥamdihī 'adada khalqih, wa riḍā nafsih, wa zinata 'arshih, wa midāda kalimātih.",
    count: 3,
    sourceCitation: 'Ṣaḥīḥ Muslim 2726.',
    sw: {
      title: 'Tasbīḥ ya Juwayriyah',
      meaning:
        'Ametakasika Allah, na sifa njema ni Zake, kwa idadi ya viumbe Vyake, na kwa kadiri ya kumridhisha Nafsi Yake, na kwa uzito wa Kiti Chake cha Enzi, na kwa wingi wa maneno Yake.',
      benefit:
        'Mtume ﷺ alimfundisha Bibi Juwayriyah maneno haya, akimwambia: "Umesema maneno manne, lau yangepimwa dhidi ya uliyoyasema tangu leo asubuhi, yangeyashinda uzito." — Ṣaḥīḥ Muslim (2726).',
    },
  },
  {
    id: 'asubuhi-22-elimu-riziki-matendo',
    arabic: 'اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلًا مُتَقَبَّلًا',
    translit: "Allāhumma innī as'aluka 'ilman nāfi'ā, wa rizqan ṭayyibā, wa 'amalan mutaqabbalā.",
    count: 1,
    sourceCitation: 'Ibn Mājah 925; graded ḥasan by Al-Albani.',
    sw: {
      title: 'Dua ya Elimu, Riziki na Matendo',
      meaning: 'Ewe Allah, nakuomba elimu yenye manufaa, riziki njema, na matendo yanayokubalika.',
      benefit: 'Mtume ﷺ alikuwa akiisema baada ya kuswali Alfajiri. — Ibn Mājah (925).',
    },
  },
  {
    id: 'asubuhi-23-istighfar',
